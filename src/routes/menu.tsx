              ...
              <Reveal key={d.name} delay={i * 0.04}>
                ...
                >
                  ...
                  <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between">
                    <div>
                      <h3 className="font-display text-base sm:text-lg text-[color:var(--foreground)] group-hover:text-[color:var(--primary)] transition-colors">{d.name}</h3>
                    ...
                    <div className="mt-4 pt-3 border-t border-[color:var(--border)] flex items-center gap-2">
                      <QuickAddBasket dish={d} variant="button" className="flex-1 h-[48px] min-h-[48px]" />
                      <a
                        href={itemWaUrl}
                        target="_blank"
                        rel="noreferrer"
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="min-w-0">
                        <h3 className="font-display text-xs sm:text-base text-[color:var(--foreground)]">{item.name}</h3>
